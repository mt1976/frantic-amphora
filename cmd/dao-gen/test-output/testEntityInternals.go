...
func (record *TestEntity) insertOrUpdate(ctx context.Context, note, activity string, auditAction audit.Action, operation string) error {
...
func (record *TestEntity) postGet() error {
...
func (record *TestEntity) checkForDuplicate() error {
